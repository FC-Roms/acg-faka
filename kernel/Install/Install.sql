...
INSERT INTO `acg_config` VALUES (49, 'user_center_mobile_theme', '0');
INSERT INTO `acg_config` VALUES (50, 'callback_ip_whitelist', '0');
INSERT INTO `acg_config` VALUES (51, 'callback_ip_whitelist_rules', '');
...
DROP TABLE IF EXISTS `acg_manage_session`;
...
INSERT INTO `acg_manage` VALUES (1, '__MANAGE_EMAIL__', '__MANAGE_PASSWORD__', NULL, '__MANAGE_NICKNAME__', '__MANAGE_SALT__', '/favicon.ico', 1, 0, '1997-01-01 00:00:00', NULL , NULL, NULL, NULL, NULL, NULL);


CREATE TABLE `acg_manage_session` (
...
DROP TABLE IF EXISTS `acg_ticket_message`;
DROP TABLE IF EXISTS `acg_ticket`;
CREATE TABLE `acg_ticket` (
                                   `id` int UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id',
...
CREATE TABLE `acg_ticket_message` (
                                           `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id',
...
DROP TABLE IF EXISTS `acg_user_message`;
DROP TABLE IF EXISTS `acg_system_message`;
CREATE TABLE `acg_system_message` (
                                          `id` int UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id',
