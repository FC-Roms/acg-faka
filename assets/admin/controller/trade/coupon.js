!function () {
    ...
    table.setFloatMessage([
        ...
        , {field: 'group_ids', title: '适用QQ群', formatter: value => escapeHtml(value || '-')}
        , {
    ...
    table.setColumns([
        ...
        , {field: 'life', title: '剩余次数', formatter: (value, item) => Number(item.user_limit) === 3 ? '按群成员验证' : escapeHtml(value)}
