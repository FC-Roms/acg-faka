...
class Coupon extends Manage
{
    ...
    {
        if (DB::schema()->hasColumn("coupon", "user_limit")) {
            return true;
        }

        try {
            DB::schema()->table("coupon", function (Blueprint $blueprint) {
        ...
        return DB::schema()->hasColumn("coupon", "user_limit");
    }
    ...
    public function save(): array
    {
        ...
        $userLimit = (int)($_POST['user_limit'] ?? 0);
        $groupIds = null;
        ...
        $hasUserLimitColumn = DB::schema()->hasColumn("coupon", "user_limit");
        ...
        $hasGroupIdsColumn = DB::schema()->hasColumn('coupon', 'group_ids');
